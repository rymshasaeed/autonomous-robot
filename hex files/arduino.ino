...
const int rs=1, en=0, d4=5, d5=4, d6=3, d7=2;     // pins of LCD connected to Arduino
...
void loop()
{
  ...
  analogWrite(motorSpeed, 100);                // SETTING MOTORS SPEED YOU CAN SET SPEED BETWEEN 0-255
